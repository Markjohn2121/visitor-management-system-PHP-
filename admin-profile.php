...
if (strlen($_SESSION['cvmsaid']==0)) {
  ...
  $type = 'admin';
      ...
      $query=mysqli_query($con, "update tbladmin set AdminName='$AName', MobileNumber ='$mobno', Email= '$email',type='$type' where ID='$adminid'");
    if ($query) {
...
?>
                                            ...
                                            <div class="card-footer">
                                                <p style="text-align: center;"><button
                                                        style="padding:0.7em; font-size:large" type="submit"
                                                        name="submit" id="submit" class="btn btn-primary btn-sm">Update
                                                    </button></p>
                                                <a href="new-user.php">
                                                    <p
                                                        style="text-align: center;padding:0.7em; font-size:large;cursor:pointer">
                                                        Create New User</p>
                                                </a>
