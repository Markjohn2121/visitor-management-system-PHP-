                        ...
                        <div class="">
                            ...
                            <div class="">
                                ...
                                <div class="newVisitTable-con">
                                    ...
                                    <a href="visitors-form.php" class="btn btn-primary fa fa-user" style="color: aqua;margin-bottom:1em; border-radius:1em; padding:1em;">
                                    ...
                                    <div class="table-con table-responsive " style="height:70vh;overflow:auto">
                                        <table class="table table-bordered table-hover  table-md " style="">
                                            ...
                                            <?php
                                            $ret = mysqli_query($con, "select *from tblvisitor where date(EnterDate)=CURDATE() ORDER BY ID DESC");
                                            $cnt = 1;
