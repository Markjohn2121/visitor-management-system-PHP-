...
if (strlen($_SESSION['cvmsaid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($query) {
            ...
            echo "<script>window.location.href = 'user-visitors-form.php'</script>";
        }
    }
    ...
    <body class="animsition">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-md-12" style=" ">
                                    <div class=" card-con card" style=" ">
                                        <div class="card-header">
                                            <strong>Add</strong> New Visitors
                                        </div>
                                        <div class="  card-body card-block" ">
                                            <form class=" newVisit-con" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input class="in-form" type="text" id="fullname" name="fullname" placeholder="Full Name" class="form-control" required="">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input class="in-form" type="email" id="email" name="email" placeholder="Enter Email" class="form-control" required="">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input class="in-form" type="text" id="mobilenumber" name="mobilenumber" placeholder="Mobile Number" class="form-control" maxlength="10" required="">
        ...
        <?php } ?>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="address" id="address" rows="1" placeholder="Enter Visitor Address..." class="form-control" required=""></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea type="text" id="reasontomeet" name="reasontomeet" rows="2" placeholder="Reason To Meet" class="form-control" required=""></textarea>

                                                </div>
                                            </div>

                                            <div class="card-footer">
                                                <p style="text-align: center;"><button type="submit" name="submit" id="submit" class="btn btn-primary btn-lg">Submit
                                                    </button></p>
